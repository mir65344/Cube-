    ...
    eq: {
        ...
        questions: [
            ...
            },
            {
                ...
                correctAnswers: ['радость', 'спокойствие', 'интерес'],
                incorrectAnswers: ['гнев', 'тревога', 'скука', 'раздражение'],
                points: 3
            },
            // Практические вопросы (случайно выбираются из базы)
            {
                ...
                placeholder: 'Например: тревога, неуверенность, волнение...',
                correctAnswers: ['тревога', 'нервозность', 'неуверенность', 'волнение', 'опасение'],
                incorrectAnswers: ['радость', 'гнев', 'отвращение', 'гордость', 'облегчение']
            }
        ]
    },
    ...
    empathy: {
        ...
        questions: [
            // База практических вопросов для случайного выбора
            {
                ...
                correctAnswers: ['первый: раздражение, гнев, frustration', 
            ...
            },
            {
                ...
                correctAnswers: ['когда близкому плохо', 'при виде несправедливости', 'когда человек просит поддержки'],
